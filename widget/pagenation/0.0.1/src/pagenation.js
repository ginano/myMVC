...
define('widget/pagenation',[
   ...
   var page=new Class('widget/pagenation',{
       ...
       public__init:function(option){
           var self=this,
               opt=self.options=$({},self.defaultOption,option),
               el=opt.rootDom,
               els=opt.elements,
               temp;
            //初始化必备标签
            el.html('<div class="widget-pagination"><ul class="page-list"></ul><div class="page-stat"></div></div>'); 
       ...
       public__renderHTML:function(currentPage,Pagetotal){
           ...
           if (cur > total) {
            ...
            //end     
            if (cur == 1) {
                html.push('<li><a class="prev prev-disable" target="_self" href="javascript:;"> </a></li>');
                html.push('<li><a class="active" target="_self" href="javascript:;">1</a></li>');
            }
            else {
                html.push('<li><a class="prev" target="_self" href="javascript:;" data-page="' + (cur - 1) + '"> </a></li>');
       ...
       public__gotoPage:function(page){
            var _opt=this.options;
            this._setHTML(page,_opt.pageCount);
            if(_opt.onPage){
